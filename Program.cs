    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (!exit)
            {
                ...
                Console.WriteLine("5. Read all available products in stock");
                ...
                Console.WriteLine("9. Add product to cart");
                Console.WriteLine("10. Empty or modify cart");
                Console.WriteLine("11. Add payment method");
                Console.WriteLine("12. Read payment method");
                Console.WriteLine("13. Update payment method");
                Console.WriteLine("14. Delete payment method");
                Console.WriteLine("15. Purchase cart's products");
                Console.WriteLine("16. Read purchase history from orders");
                Console.WriteLine("17. Re-buy product with old placed order");
                Console.WriteLine("18. Calculate total spent on products for user");
                Console.WriteLine("19. Calculate daily revenue from sales");
                Console.WriteLine("20. Calculate total price of product with tax");
